<template>
  <div>
    ...
    <b-container class="pt-5 pb-5">
      ...
      <p class="text-primary">For more information on where GRADE-CERQual fits into the review process please see the <a href="https://zenodo.org/record/5973704#.ZEaQJ3bMLrd" target="_blank"><u>EPOC QES protocol and review template.</u></a></p>
