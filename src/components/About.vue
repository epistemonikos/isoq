<template>
  <div>
    ...
    <b-container class="pt-5">
      ...
      <p>GRADE-CERQual is an approach for transparently assessing and describing how much confidence decision makers and other users can place in individual review findings from syntheses (or systematic reviews) of qualitative evidence. An overall GRADE-CERQual assessment of confidence is based on an assessment of four components: methodological limitations, coherence, adequacy and relevance.</p>
      ...
      <p>No, this tool is specific to applying the GRADE-CERQual approach. It is not a replacement for other commonly used software in systematic reviews like reference management software (e.g. Endnote), software for screening and selecting studies (e.g. Covidence and Distiller SR), or software and programs for extracting and analyzing data (e.g. DistillerSR, NVivo, Microsoft Excel).</p>
      <h3>Can you invite collaborators to an iSoQ?</h3>
      ...
      <h3>Can I export from iSoQ into other programs?</h3>
      <p>Currently you cannot directly export the iSoQ into other platforms but you can export and download a Microsoft Word or PDF copy of the Summary of Qualitative Findings Table and Evidence Profile Table. These can be copy and pasted or imported into other programs such as RevMan, GRADEpro GDT, or MAGICapp. Characteristics of Studies, Methodological Assessments and Extracted Data tables created in iSoQ can be downloaded into a Microsoft Excel compatible format.</p>
      <h3>Can iSoQs be made public for anyone to see?</h3>
