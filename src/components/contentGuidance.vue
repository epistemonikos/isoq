<template>
  <div>
    <h2 class="mb-3">{{ $t('guidance.title') }}</h2>

    <h3>{{ $t('guidance.intro') }}</h3>
    ...
    <h3>{{ $t('guidance.methodological') }}</h3>
    ...
    <i18n path="guidance.webinars_desc" tag="p">
      <a href="https://www.cerqual.org/upcoming-events/" target="_blank" place="0">{{ $t('guidance.sign_up') }}</a>
    </i18n>
    <i18n path="guidance.intro_videos" tag="p">
      <a href="https://www.cerqual.org/grade-cerqual-videos/" target="_blank" place="0">{{ $t('guidance.intro_videos_link') }}</a>
    </i18n>
    <i18n path="guidance.training_webinar" tag="p">
      <a href="https://training.cochrane.org/resource/grade-cerqual-webinar" target="_blank" place="0">{{ $t('guidance.training_webinar_link') }}</a>
    </i18n>
    <i18n path="guidance.mailing_list" tag="p">
      <a href="https://www.cerqual.org/contact/" target="_blank" place="0">{{ $t('guidance.mailing_list_link') }}</a>
    </i18n>
