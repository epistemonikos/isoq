<template>
  <div>
    ...
    <p>For more information on where GRADE-CERQual fits into the review process please see the <a href="https://zenodo.org/record/5973704#.ZEaQJ3bMLrd" target="_blank">EPOC QES protocol and review template</a>.</p>
    ...
    <p>Watch the <a href="https://www.cerqual.org/grade-cerqual-videos/" target="_blank">Introduction to GRADE-CERQual videos</a> here at your convenience.</p>
    <p>
