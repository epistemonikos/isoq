export default class Commons {
  ...
  static theLicense (license = '') {
    const globalLicenses = [
      {
        value: 'CC-BY-NC-ND',
        text: 'CC BY-NC-ND: This licence allows reusers to copy and distribute the material in any medium or format in unadapted form only, for noncommercial purposes only, and only so long as attribution is given to the creator.',
        image: 'by-nc-nd-88x31.png'
      },
      { value: 'CC-BY-ND', text: 'CC BY-ND: This licence allows reusers to copy and distribute the material in any medium or format in unadapted form only, and only so long as attribution is given to the creator. The licence allows for commercial use.', image: 'by-nd-88x31.png' },
      { value: 'CC-BY-NC-SA', text: 'CC BY-NC-SA: This licence allows reusers to distribute, remix, adapt, and build upon the material in any medium or format for noncommercial purposes only, and only so long as attribution is given to the creator. If you remix, adapt, or build upon the material, you must license the modified material under identical terms.', image: 'by-nc-sa-88x31.png' },
      { value: 'CC-BY-NC', text: 'CC BY-NC: This licence allows reusers to distribute, remix, adapt, and build upon the material in any medium or format for noncommercial purposes only, and only so long as attribution is given to the creator.', image: 'by-nc-88x31.png' },
      ...
      { value: 'CC-BY', text: 'CC BY: This licence allows reusers to distribute, remix, adapt, and build upon the material in any medium or format, so long as attribution is given to the creator. The licence allows for commercial use.', image: 'by-88x31.png' }
    ]
